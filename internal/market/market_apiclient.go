...
type MarketApiclient interface {
	...
	GetLatestMarketPrice() (ArcMetaIntegratorPrice, error)
	GetLiveMarketUpdates() (*LiveMarketUpdatesResponse, error)
}
...
func (s *marketApiclient) GetLatestMarketPrice() (ArcMetaIntegratorPrice, error) {
	// var forexPriceData []ForexPriceResponse
	var forexPriceData ArcMetaIntegratorPrice
	client := &http.Client{
	...
	if err != nil {
		...
		return ArcMetaIntegratorPrice{}, err
	}
	...
	if err != nil {
		...
		return ArcMetaIntegratorPrice{}, fmt.Errorf("failed to unmarshal response: %w", err)
	}
...
func (s *marketApiclient) GetLiveMarketUpdates() (*LiveMarketUpdatesResponse, error) {
	liveMarketUpdatesResponse := LiveMarketUpdatesResponse{
