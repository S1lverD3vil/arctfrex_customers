...
func (wh *withdrawalHandler) WithdrawalByAccountId(c *gin.Context) {
	...
	c.JSON(
		http.StatusOK,
		model.WithdrawalApiResponse{ApiResponse: base.ApiResponse{Message: "success", Data: withdrawals}},
	)
}
...
func (wh *withdrawalHandler) BackOfficePendingDetail(c *gin.Context) {
	...
	c.JSON(http.StatusOK, model.WithdrawalApiResponse{ApiResponse: base.ApiResponse{
		Message: "success",
...
func (wh *withdrawalHandler) BackOfficePendingApproval(c *gin.Context) {
	var backOfficeApproval *model.BackOfficePendingWithdrawalApprovalRequest
	...
	c.JSON(
		http.StatusOK,
		model.WithdrawalApiResponse{ApiResponse: base.ApiResponse{Message: "success"}},
	)
}

func (wh *withdrawalHandler) BackOfficePendingSPA(c *gin.Context) {
	menutype := c.Param("menutype")
	request := model.WithdrawalBackOfficeParam{
		Menutype: menutype,
	}
