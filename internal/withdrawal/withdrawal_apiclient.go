...
type WithdrawalApiclient interface {
	TradeWithdrawal(tradeWithdrawal TradeWithdrawal) (TradeWithdrawal, error)
}
...
func (s *withdrawalApiclient) TradeWithdrawal(tradeWithdrawal TradeWithdrawal) (TradeWithdrawal, error) {
	var tradeWithdrawalData TradeWithdrawal
