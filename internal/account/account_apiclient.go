...
func (s *accountApiclient) ClientAdd(clientAdd ClientAdd) (ClientAdd, error) {
...
func (s *accountApiclient) DemoAccountTopUp(demoAccountTopUp DemoAccountTopUp) (DemoAccountTopUp, error) {
