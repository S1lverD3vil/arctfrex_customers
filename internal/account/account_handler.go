...
func (ah *accountHandler) Submit(c *gin.Context) {
	...
	if err := ah.accountUsecase.Submit(&Account{UserID: userId}); err != nil {
...
func (ah *accountHandler) Pending(c *gin.Context) {
	...
	c.JSON(
		http.StatusOK,
		AccountApiResponse{Message: "success", Data: accounts},
	)
}
...
func (ah *accountHandler) BackOfficePendingApproval(c *gin.Context) {
	...
	c.JSON(
		http.StatusOK,
		AccountApiResponse{Message: "success"},
	)
}
