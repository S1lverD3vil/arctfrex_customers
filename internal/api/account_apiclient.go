...
func NewAccountApiclient() AccountApiclient {
	return &accountApiclient{}
}

func (s *accountApiclient) ClientAdd(clientAdd model.ClientAdd) (model.ClientAdd, error) {
...
func (s *accountApiclient) DemoAccountTopUp(demoAccountTopUp model.DemoAccountTopUp) (model.DemoAccountTopUp, error) {
